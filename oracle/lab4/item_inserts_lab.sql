...
,(SELECT   common_lookup_lab_id
  ...
  WHERE    common_lookup_lab_context = 'ITEM'
...
,(SELECT   common_lookup_lab_id
  FROM     common_lookup_lab
  WHERE    common_lookup_lab_context = 'ITEM'
  AND      common_lookup_lab_type = 'DVD_FULL_SCREEN')
,'Star Wars II'
...
,(SELECT   common_lookup_lab_id
  FROM     common_lookup_lab
  WHERE    common_lookup_lab_context = 'ITEM'
  AND      common_lookup_lab_type = 'XBOX')
,'RoboCop'
,''
,'Mature'
,'24-JUL-03'
...
,(SELECT   common_lookup_lab_id
  FROM     common_lookup_lab
  WHERE    common_lookup_lab_context = 'ITEM'
  AND      common_lookup_lab_type = 'NINTENDO_GAMECUBE')
,'MarioKart'
,'Double Dash'
,'Everyone'
,'17-NOV-03'
...
,(SELECT   common_lookup_lab_id
  FROM     common_lookup_lab
  WHERE    common_lookup_lab_context = 'ITEM'
  AND      common_lookup_lab_type = 'PLAYSTATION2')
,'Splinter Cell'
,'Chaos Theory'
,'Teen'
,'08-APR-03'
...
,(SELECT   common_lookup_lab_id
  FROM     common_lookup_lab
  WHERE    common_lookup_lab_context = 'ITEM'
  AND      common_lookup_lab_type = 'BLU-RAY')
,'Beau Geste'
,''
,'PG'
,'01-MAR-92'
