-- ------------------------------------------------------------------
--  Program Name:   system_user_lab_inserts.sql
--  Lab Assignment: N/A
...
COL member_labs             FORMAT 9999  HEADING "member_lab|#"
COL common_lookup_lab_type  FORMAT A12   HEADING "Common|Lookup Type"
...
CREATE OR REPLACE VIEW current_rental AS
  ...
  ,        SUBSTR(cl.common_lookup_lab_meaning,1,3) AS product
  ,        r.check_out_date
  ,        r.return_date
  FROM     member_lab m INNER JOIN contact_lab c ON m.member_lab_id = c.member_lab_id INNER JOIN
           ...
           common_lookup_lab cl ON i.item_id = cl.common_lookup_lab_id
  ORDER BY 1, 2, 3;
