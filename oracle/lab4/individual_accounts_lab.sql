...
-- Insert first contact_lab.
BEGIN
  /* Call the contact_lab_insert procedure. */
  contact_lab_insert(
      pv_member_lab_type => 'INDIVIDUAL'
    ...
    , pv_contact_lab_type => 'CUSTOMER'
    , pv_address_lab_type => 'HOME'
    , pv_city => 'Provo'
    , pv_state_province => 'Utah'
    , pv_postal_code => '84606'
    , pv_street_address_lab => '118 South 9th East'
    , pv_telephone_lab_type => 'HOME'
    , pv_country_code => '001'
    , pv_area_code => '801'
    , pv_telephone_lab_number => '423-1234' );
END;
/

-- Insert second contact_lab.
BEGIN
  /* Call athe contact_lab_insert procedure. */
  contact_lab_insert(
      pv_member_lab_type => 'INDIVIDUAL'
    ...
    , pv_country_code => '001'
    , pv_area_code => '801'
    , pv_telephone_lab_number => '423-1235' );
END;
/

-- Insert third contact_lab.
BEGIN
  /* Call the contact_lab_insert procedure. */
  contact_lab_insert(
      pv_member_lab_type => 'INDIVIDUAL'
    ...
    , pv_country_code => '001'
    , pv_area_code => '801'
    , pv_telephone_lab_number => '423-1236' );
END;
/

-- Insert fourth contact_lab.
BEGIN
  /* Call the contact_lab_insert procedure. */
  contact_lab_insert(
      pv_member_lab_type => 'INDIVIDUAL'
    ...
    , pv_country_code => '001'
    , pv_area_code => '801'
    , pv_telephone_lab_number => '423-1237' );
END;
/

-- Insert fifth contact_lab.
BEGIN
  /* Call the contact_lab_insert procedure. */
  contact_lab_insert(
      pv_member_lab_type => 'INDIVIDUAL'
    ...
    , pv_country_code => '001'
    , pv_area_code => '801'
    , pv_telephone_lab_number => '423-1238' );
END;
/
